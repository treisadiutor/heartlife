...
<body class="bg-darkbg h-screen w-screen overflow-hidden font-porky text-ghost pixel-bg" style="background-image: url('<?= BASE_URL ?>/assets/images/background.png'); background-size: cover; background-position: center; backdrop-filter: blur(15px);">
